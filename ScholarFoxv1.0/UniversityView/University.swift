...
var csu = [
    ...
    University(image: "DH", name: "California State University, Dominguez Hills", city: "City: Carson, CA", minimum_gpa: "Minimum GPA: 3.0", acceptanceRating: "Acceptance Rate: 87%", average_cost: "Tuition: $8.4K", description: "California State University—Dominguez Hills is a public institution that was founded in 1960. It has a total undergraduate enrollment of 15,070 (fall 2021), its setting is suburban, and the campus size is 346 acres. It utilizes a semester-based academic calendar. California State University—Dominguez Hills' ranking in the 2022-2023 edition of Best Colleges is Regional Universities West, #56. ", recommendations: "https://www.csudh.edu/coe/apply/"),
    University(image: "", name: "California State Polytechnic University", city: "Pomona, CA", minimum_gpa: "Minimum GPA: 3.0", acceptanceRating: "Acceptance Rate: 65%", average_cost: "Tuition: $7.5K", description: "California State Polytechnic University—Pomona is a public institution that was founded in 1938. It has a total undergraduate enrollment of 26,974 (fall 2021), its setting is suburban, and the campus size is 1,438 acres. It utilizes a semester-based academic calendar. California State Polytechnic University—Pomona's ranking in the 2022-2023 edition of Best Colleges is Regional Universities West, #14.", recommendations: "https://www.calpoly.edu/admissions/first-year-student/how-to-apply")
]
